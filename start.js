...
function createChart() {
    ...
    let history = rs.settings.wealthManagementMod.investmentHistory;
    let investmentDay = Number.parseInt(rs.settings.wealthManagementMod.investmentDay);
    ...
    exports.views = [
        {
            ...
            controller: function ($rootScope) {
                ...
                this.getCurrentValue = function () {
                    let factor = getLastDays(rs.settings.wealthManagementMod.investmentHistory.length) / 100;
                    return factor * rs.settings.wealthManagementMod.investmentAmount + rs.settings.wealthManagementMod.investmentAmount;    
                }
                ...
                this.investAmount = function (amount) {
                    ...
                    if (rs.settings.wealthManagementMod && rs.settings.wealthManagementMod.hasInvested == true) {
                        let factor = getLastDays(rs.settings.wealthManagementMod.investmentHistory.length) / 100;
                        money = factor * rs.settings.wealthManagementMod.investmentAmount + rs.settings.wealthManagementMod.investmentAmount;
                    ...
                    rs.safeBuy(function () {
                        ...
                        hasError = false;
                    }, amount, "Wealth Management Pay In");
                ...
                this.hasInvested = function () {
                    return rs.settings.wealthManagementMod == undefined ? false : rs.settings.wealthManagementMod.hasInvested;
                }

                this.getInvestedAmount = function () {
                    return rs.settings.wealthManagementMod == undefined ? 0 : rs.settings.wealthManagementMod.investmentAmount;
                }
                ...
                this.closeInvestment = function () {
                    let factor = getLastDays(rs.settings.wealthManagementMod.investmentHistory.length) / 100;
                    let money = factor * rs.settings.wealthManagementMod.investmentAmount + rs.settings.wealthManagementMod.investmentAmount;
                ...
                this.getCurrentValue = function () {
                    let factor = getLastDays(rs.settings.wealthManagementMod.investmentHistory.length);
                    return (factor/100) * rs.settings.wealthManagementMod.investmentAmount + rs.settings.wealthManagementMod.investmentAmount; 
                }
...
exports.onNewDay = settings => {
    if (settings.wealthManagementMod && settings.wealthManagementMod.hasInvested == true) {
